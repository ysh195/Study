...
// 매 회차마다 N을 2로 나누면서, N을 2로 나누는 게 가능한 만큼만 반복문을 진행하기 때문에
// 코드의 실행횟수는 N/2이고, N의 최댓값은 500,000이기 때문에, 이 코드의 최대 실행횟수는 250,000이다.
// 실행횟수 100,000,000이 대략 1초이고, 100,000,000는 250,000의 400배이니,
// 제한시간인 0.1초보다 훨씬 작은 1/400초 내에 모든 계산을 끝낼 수 있다.
